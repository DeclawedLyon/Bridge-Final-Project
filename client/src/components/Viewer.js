  ...
  return (
    <main className="viewer">
      ...
      <div className="description">
        ...
        <p><b>Estimated Delivery Date: </b>{state.thisPackage.estimated_delivery ? state.thisPackage.estimated_delivery : ""}</p>
        <p><b>Delivery Date: </b>{state.thisPackage.date_delivered ? state.thisPackage.estimated_delivery : ""}</p>
        <p><b>Date Sent: </b>{state.thisPackage.date_sent ? state.thisPackage.date_sent : ""}</p>
        <p><b>Sent To: </b>{state.thisPackage.sent_to ? state.thisPackage.sent_to : ""}</p>
        <p><b>Sent From: </b>{state.thisPackage.sent_from ? state.thisPackage.sent_from : ""}</p>
